...
export const NavbarRoutes = () => {
  ...
  const isPlayerPage =
    pathname?.includes("/courses/") && !pathname?.includes("/courses/search");
    ...
    <>
      ...
      <div className="flex gap-x-2 ml-auto items-center">
        {isTeacherPage || isPlayerPage ? (
          <Link href="/courses" about="Go back to courses">
          ...
          isTeacher && (
            <Link href="/courses/teacher" about="Go to teacher mode">

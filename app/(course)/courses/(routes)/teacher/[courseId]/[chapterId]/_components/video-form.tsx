    ...
    <div className="mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {isEditing && (
        <div>
          ...
          <div className="text-xs text-muted-forground mt-4">
            <p>You can upload a video up to 1GB in size.</p>
            <p>
              We support most video formats, but recommend using a MP4 file to
              ensure that your video can be played on all devices.
            </p>
          </div>
        </div>
      )}
      {initialData.videoUrl && !isEditing && (
        <div className="text-xs text-muted-forground mt-2">
          Video can take a few minutes to process. Refresh the page if the dose
          not appear hare.
        </div>
      )}
    </div>

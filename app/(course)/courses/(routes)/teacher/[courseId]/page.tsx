...
const CourseSetupPage = async ({
  ...
  return (
    <>
      {!course.isPublished && (
        <Banner label="Your course is not published yet.It will be visible to students once you publish it." />
      )}
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          <div>
            <div className="flex items-center gap-x-2">
              ...
              <h2 className="text-xl">Coustomise your course</h2>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-x-2">
              ...
              <h2 className="text-xl">Resources & Attachmentes</h2>
            </div>
